...
{
    public class ClientWhiserReceivedEvent() : TwitchEvent("user.whisper.message", 1, true)
    {

    }

    public class ClientWhiserReceivedArgs
    {
        ...
        public ClientWhiserReceivedArgs(TwitchClient client, JsonElement payload)
        {
